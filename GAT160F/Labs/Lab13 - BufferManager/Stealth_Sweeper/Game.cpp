...
bool Game::Initialize(MeGlWindow* window)
{
	...
	dragon2 = new Renderable(m_window->width(), m_window->height(), &programID, generator->MakeObject("../Data/Scenes/SpecialCube.pctn.scene"), m_logs);
	dragon3 = new Renderable(m_window->width(), m_window->height(), &programID, generator->MakeObject("../Data/Scenes/SpecialCube.pctn.scene"), m_logs);
	dragon4 = new Renderable(m_window->width(), m_window->height(), &programID, generator->MakeObject("../Data/Scenes/Dargon.pc.scene"), m_logs);
	...
	m_renderEngine.addRenderable(dragon3);
	m_renderEngine.addRenderable(dragon4);
...
bool Game::Update(float dt)
{
	...
	if (!m_paused)
	{
		...
		dragon3->Update(glm::vec3(10.0f, 0.0f, -5.0f), 40.0f);
		dragon4->Update(glm::vec3(-5.0f, 0.0f, 3.0f), 40.0f);
	}
