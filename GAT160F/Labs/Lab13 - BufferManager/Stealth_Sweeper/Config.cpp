...
bool Config::IsBlankOrCommentwithPound(std::string s)
{
...
void Config::LogConfig()
{
	...
	{
		logs->LogErrors(LOG_INFO, "Key number %d: %s - %s", usedValues, keys[usedValues], values[usedValues]);
	}
}
